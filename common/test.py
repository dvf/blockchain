...
if __name__ == '__main__':
    print IntFormatW(123456789.1234)
    print IntFormatWV2(123456789.1234)
    print PercentFormat(789.1234111)
    print Template('<%=key%>',{'key':'value'});
    print '==';

    dic = {};
    li = [];

    li.append(dict({'key':'value'}));
    ...
    print Template('<volist id=k><%=k.key%>\n</volist>', result);
